...
$('timeline').oninput=()=>{playing=false;$('play').textContent='播放';seek(indexAt(+$('timeline').value));};
...
window.swiftState={loaded,display,scaleFactor:scaleAt(display),timeMode:'linear-a',visible,cacheCount:cache.size,fetching,fps,yaw,distance,glError:gl.getError()};requestAnimationFrame(draw);}
