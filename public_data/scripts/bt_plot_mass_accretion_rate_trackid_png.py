#!/usr/bin/env python3
"""TrackId FOF mass-accretion diagnostic for PL and bluetilted models.

This is a catalog-level diagnostic built to mirror the half-mass-redshift
measurement: z=0 FOF halos are selected at snapshot 0056 and then matched by
HBT-HERONS TrackId through the SOAP HBTplus catalogs.
"""
...
def main() -> None:
    ...
    cache_dir = output_dir / "mass_accretion_rate_trackid_cache"
    ...
    bybin_path = output_dir / "mass_accretion_rate_bybin.csv"
    summary_path = output_dir / "mass_accretion_rate_summary.csv"
